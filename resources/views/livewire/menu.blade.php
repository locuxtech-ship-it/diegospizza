<div class="min-h-screen bg-white text-gray-900 font-sans" style="font-family: 'Poppins', sans-serif;">
    {{-- Hero / Header --}}
    <div class="relative text-white overflow-hidden bg-gray-900" style="background-image: linear-gradient(to bottom, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.5) 70%, rgba(0,0,0,0.4) 100%), url('/storage/images/llanera.jpeg'); background-size: cover; background-position: center;">
        <div class="max-w-4xl mx-auto px-4 py-8 sm:py-12">
            <div class="flex flex-col items-center text-center gap-4">
                <div class="flex items-center gap-3">
                    ...
                    @endif
                    <div>
                        <h1 class="text-xl sm:text-3xl font-bold tracking-tight drop-shadow-lg">
                            {{ $negocio->nombre_negocio ?? "Diego's Pizza" }}
                        </h1>
                        <p class="text-gray-300 mt-0.5 text-xs sm:text-sm drop-shadow">Bienvenido a Diego's Pizza Alameda</p>
                    </div>
                </div>

                <div class="flex flex-col sm:flex-row sm:flex-wrap items-center justify-center gap-1.5 sm:gap-4 text-xs sm:text-sm text-gray-300">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="https://wa.me/573106444759?text=Hola%2C%20quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20sus%20productos" target="_blank" rel="noopener" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/15 hover:bg-white/25 backdrop-blur-sm transition-all duration-200 border border-white/20 hover:border-white/40" title="Escríbenos por WhatsApp">
                        ...
                        <a href="https://www.instagram.com/diegospizzabq/" target="_blank" rel="noopener" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/15 hover:bg-white/25 backdrop-blur-sm transition-all duration-200 border border-white/20 hover:border-white/40" title="Síguenos en Instagram">
                ...
                <div class="flex items-center gap-1.5 bg-black/40 backdrop-blur-sm px-3 py-1.5 sm:py-2 rounded-full border border-white/20">
