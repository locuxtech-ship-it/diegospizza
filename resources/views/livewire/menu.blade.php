    ...
    <div class="relative text-white overflow-hidden bg-gray-900" style="background-image: linear-gradient(to bottom, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.5) 70%, rgba(0,0,0,0.4) 100%), url('/storage/images/llanera.jpeg'); background-size: cover; background-position: center;">
        <div class="max-w-4xl mx-auto px-4 py-8 sm:py-12">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-1.5 bg-black/40 backdrop-blur-sm px-3 py-1.5 sm:py-2 rounded-full border border-white/20 self-start sm:self-auto">
            ...
            <div class="flex flex-col sm:flex-row sm:flex-wrap items-center gap-1.5 sm:gap-4 mt-5 text-xs sm:text-sm text-gray-300">
