                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; gap: 6px; margin-top: 12px; padding-top: 12px; border-top: 1px solid #e5e7eb;">
                                    <div style="display: flex; align-items: center; gap: 4px;">
                                        ...
                                        @if(!empty($pedido['cliente']['telefono']))
                                            ...
                                            <a href="https://wa.me/{{ $waTelKanban }}?text={{ urlencode('Hola! Te escribimos de {{ $negocio->nombre_negocio ?? 'Facilo' }} por tu pedido #' . $pedido['numero_pedido']) }}" target="_blank" onclick="event.stopPropagation()" style="display: inline-flex; align-items: center; gap: 3px; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 500; text-decoration: none; background: #dcfce7; color: #25D366; border: 1px solid #bbf7d0;">
