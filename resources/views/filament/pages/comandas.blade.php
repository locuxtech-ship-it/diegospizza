    ...
    <div style="display: flex; flex-direction: column; gap: 24px;" wire:poll.keep-alive.5s="cargarPedidos">
        ...
        <div style="background: white; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
            ...
            <div wire:click="editarPedido({{ $pedido['id'] }})" style="display: grid; grid-template-columns: 60px 1fr 1fr 1.5fr 70px 70px 80px 120px 140px; gap: 0; border-bottom: 1px solid #f3f4f6; font-size: 13px; cursor: pointer; transition: background 0.15s;"
                ...
                <div style="padding: 10px 12px; color: #6b7280;">{{ $pedido['cliente']['telefono'] ?? '' }}</div>
                <div style="padding: 10px 12px; font-size: 11px; color: #6b7280; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{ $dir }}">{{ $dir }}</div>
                ...
                <div style="padding: 10px 12px; text-align: right; font-weight: 600;">${{ number_format($pedido['total'], 0, ',', '.') }}</div>
                <div style="padding: 10px 12px; text-align: center;">
                ...
                <div style="padding: 8px 12px; text-align: center; display: flex; gap: 4px; align-items: center; justify-content: center;">
                    ...
                    <a href="/admin/pedidos/{{ $pedido['id'] }}/edit" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 6px; font-size: 11px; text-decoration: none; background: #f3f4f6; color: #374151; border: 1px solid #e5e7eb;" title="Editar pedido">✏️</a>
                    @endif
                    <a href="#" onclick="event.stopPropagation(); printPedido({{ $pedido['id'] }}); return false;" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 6px; font-size: 11px; font-weight: 500; text-decoration: none; background: #f3f4f6; color: #374151; border: 1px solid #e5e7eb;" title="Reimprimir ticket">🖨️</a>
