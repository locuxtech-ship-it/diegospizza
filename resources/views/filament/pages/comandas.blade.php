            ...
            <div wire:click="editarPedido({{ $pedido['id'] }})" style="display: grid; grid-template-columns: 0.7fr 0.8fr 0.7fr 1.4fr auto; gap: 0; border-bottom: 1px solid #f3f4f6; font-size: 13px; cursor: pointer; transition: background 0.15s;"
                ...
                <div style="padding: 6px 8px; text-align: center; display: flex; gap: 3px; align-items: center; justify-content: center; flex-wrap: wrap;">
                    ...
                    @if(!empty($pedido['cliente']['telefono']))
                        ...
                        @php $msg = 'Hola! Te escribimos de ' . ($negocio->nombre_negocio ?? 'Facilo') . ' por tu pedido #' . $pedido['numero_pedido']; @endphp
                        <a href="https://wa.me/{{ $waTel }}?text={{ urlencode($msg) }}" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 38px; height: 38px; border-radius: 6px; font-size: 16px; font-weight: 500; text-decoration: none; background: #dcfce7; color: #25D366; border: 1px solid #bbf7d0;" title="WhatsApp cliente">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; gap: 6px; margin-top: 12px; padding-top: 12px; border-top: 1px solid #e5e7eb;">
                                    <div style="display: flex; align-items: center; gap: 4px;">
                                        ...
                                        @if(!empty($pedido['cliente']['telefono']))
                                            ...
                                            @php $waMsgKanban = 'Hola! Te escribimos de ' . ($negocio->nombre_negocio ?? 'Diego\'s Pizza') . ' por tu pedido #' . $pedido['numero_pedido']; @endphp
                                            <a href="https://wa.me/{{ $waTelKanban }}?text={{ urlencode($waMsgKanban) }}" target="_blank" onclick="event.stopPropagation()" style="display: inline-flex; align-items: center; gap: 3px; padding: 4px 8px; border-radius: 6px; font-size: 11px; font-weight: 500; text-decoration: none; background: #dcfce7; color: #25D366; border: 1px solid #bbf7d0;">
